...
$i=0;
$charadatas = array(CharacterDataSet(15,$csvpath),CharacterDataSet(18,$csvpath),CharacterDataSet(20,$csvpath),CharacterDataSet(25,$csvpath),CharacterDataSet(26,$csvpath)); //IDでキャラデータ取得
